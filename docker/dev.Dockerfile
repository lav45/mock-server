...
RUN wget https://github.com/qossmic/deptrac/releases/download/2.0.4/deptrac.phar -O /usr/local/bin/deptrac && chmod a+x /usr/local/bin/deptrac
RUN wget https://github.com/PHP-CS-Fixer/PHP-CS-Fixer/releases/download/v3.65.0/php-cs-fixer.phar -O /usr/local/bin/php-cs-fixer && chmod a+x /usr/local/bin/php-cs-fixer
