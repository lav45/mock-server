...
> Built-in [`Application`](../application.md) extension — `Lav45\MockServer\Extension\Direct\DirectExtension`.
...
For a full list of placeholders and Faker usage, see [Faker](../../faker.md).
