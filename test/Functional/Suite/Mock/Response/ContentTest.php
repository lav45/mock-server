...
class ContentTest extends TestCase
{
    ...
    {
        $response = $this->HttpClient->request('http://127.0.0.1/response/content/json2');
        $this->assertEquals(200, $response->getStatus());
    ...
    {
        $response = $this->HttpClient->request('http://127.0.0.1/response/content/text2');
        $this->assertEquals(200, $response->getStatus());
    ...
    {
        $response = $this->HttpClient->request('http://127.0.0.1/response/content/headers2');
        $this->assertEquals(200, $response->getStatus());
    ...
    public function testStatus2(): void
    {
        $response = $this->HttpClient->request('http://127.0.0.1/response/content/status2');
        $this->assertEquals(401, $response->getStatus());
        $this->assertEquals('Unauthorized', $response->getBody()->buffer());
    }
}
