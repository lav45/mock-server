...
namespace Lav45\MockServer\Test\Unit\Suite\Extension\Prepare;

use Lav45\MockServer\Engine\Http\RequestHandler;
use Lav45\MockServer\Engine\Http\ServerRequest;
use Lav45\MockServer\Engine\Http\ServerResponse;
use Lav45\MockServer\Extension\Prepare\ParserFactory;
use Lav45\MockServer\Extension\Prepare\PrepareMiddleware;
...
final class PrepareMiddlewareTest extends TestCase
{
    ...
    private function nextCapturing(VariableParser|null &$capturedParser): RequestHandler
    {
    ...
    private function nextCapturingData(array|null &$capturedData): RequestHandler
    {
